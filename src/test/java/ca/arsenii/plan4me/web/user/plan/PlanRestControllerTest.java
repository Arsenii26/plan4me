...
import static ca.arsenii.plan4me.TestUtil.readFromJson;
import static ca.arsenii.plan4me.TestUtil.readFromJsonMvcResult;
...
class PlanRestControllerTest extends AbstractControllerTest {
    ...
    void get() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(REST_URL + PLAN1_ID))
                ...
                .andExpect(result -> assertMatch(readFromJsonMvcResult(result, Plan.class), PLAN1));
    }
    ...
    void update() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put(REST_URL + PLAN1_ID).contentType(MediaType.APPLICATION_JSON)
    ...
    void createWithLocation() throws Exception {
        ...
        assertMatch(service.getAll(START_SEQ), created, PLAN6, PLAN5, PLAN4, PLAN3, PLAN2, PLAN1);
    }
