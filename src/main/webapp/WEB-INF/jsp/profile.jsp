...
<%@ taglib prefix="plan4me" tagdir="/WEB-INF/tags" %>
...
<div class="jumbotron pt-4">
    <div class="container">
        <%--@elvariable id="userTo" type="ca.arsenii.plan4me.to.UserTo"--%>
        <div class="row">
            <div class="col-5 offset-3">
                ...
                <form:form class="form-group" modelAttribute="userTo" method="post" action="${register ? 'profile/register' : 'profile'}"
                    ...
                    <plan4me:inputField labelCode="user.name" name="name"/>
                    <plan4me:inputField labelCode="user.email" name="email"/>
                    <plan4me:inputField labelCode="user.password" name="password" inputType="password"/>
