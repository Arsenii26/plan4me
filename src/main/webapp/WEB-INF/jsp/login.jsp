...
<jsp:include page="fragments/bodyHeaderForLogin.jsp"/>
        ...
        <sec:authorize access="isAnonymous()">
            <div class="col-6 mx-auto text-center m-3">
                <h3><spring:message code="app.prepared"/></h3>
    ...
    <h3><spring:message code="app.welcome"/></h3><br>
            <sec:authorize access="isAnonymous()">
                <form:form class="col-12" id="login_form" action="spring_security_check" method="post">

                    <input class="form-control" type="text" placeholder="Email" name="username"><br>
                    <input class="form-control" type="password" placeholder="Password" name="password"><br>

                    <button class="btn btn-success" type="submit">
                        <a class="btn btn-lg btn-success"><spring:message code="app.loginToAcc"/> &raquo;</a>
                    </button>
...
<div class="container lead">
    &nbsp;&nbsp;<div class="lead py-4">Technologies used: <br>
