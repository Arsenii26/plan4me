...
import ca.arsenii.plan4me.util.exception.ErrorInfo;
...
public class ExceptionInfoHandler {
    ...
    public static final String EXCEPTION_DUPLICATE_DATETIME = "exception.plan.duplicateDateTime";

    private static final Map<String, String> CONSTRAINS_I18N_MAP = Map.of(
            "users_unique_email_idx", EXCEPTION_DUPLICATE_EMAIL,
            "plans_unique_user_datetime_idx", EXCEPTION_DUPLICATE_DATETIME);
